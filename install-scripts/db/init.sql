...
CREATE TABLE IF NOT EXISTS platform(
    ...
    CONSTRAINT FK_DESCRIPTION_PLATFORM_DESCRIPTION_ID
        FOREIGN KEY (description_platform_description_id) REFERENCES platform_description(platform_description_id)
);
...
CREATE TABLE IF NOT EXISTS game_description(
    ...
    CONSTRAINT FK_PLATFORM_PLATFORM_ID
        FOREIGN KEY (platform_platform_id) REFERENCES  platform(platform_id)
);
...
CREATE TABLE IF NOT EXISTS cores(
    ...
    CONSTRAINT FK_ASSOCIATED_PLATFORM_PLATFORM_ID
        FOREIGN KEY (associated_platform_platform_id) REFERENCES platform(platform_id)
);
...
CREATE TABLE IF NOT EXISTS game(
    ...
    CONSTRAINT FK_DESCRIPTION_GAME_DESCRIPTION_ID
        FOREIGN KEY(description_game_description_id) REFERENCES game_description(game_description_id),
    CONSTRAINT FK_CORE_CORE_ID
        FOREIGN KEY(core_core_id) REFERENCES cores(core_id)
);
